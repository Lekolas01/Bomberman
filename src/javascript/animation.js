...
class Character {
    constructor(y, row, col, dim_x = 16, dim_y = 16) { //which y position on asset png is player/monster
        ...
        this.direction = new Array(4); //up, down, right and left
        ...
        //left, + 1 at dim_x, because i copied the left assets at 1 px too far right
        this.direction[3] = new Array(4);
        this.direction[3][0] = new AnimationFrame((15 * dim_x) + 1, y, dim_x, dim_y); //idle
        this.direction[3][1] = new AnimationFrame((16 * dim_x) + 1, y, dim_x, dim_y); //animation left #1
        this.direction[3][2] = new AnimationFrame((17 * dim_x) + 1, y, dim_x, dim_y); //animation left #2
        this.direction[3][3] = new AnimationFrame((18 * dim_x) + 1, y, dim_x, dim_y); //animation left #3
